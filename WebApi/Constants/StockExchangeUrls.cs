...
namespace WebApi.Constants
{
    public class StockExchangeUrls
    {
        ...
        public const string TradingStatisticsURI = @"webpages/ts/tstop30reg.php";
        public static string[] MarketStaticsURlFlags = {"REG","FUT","CSF","SIF","NDM","SQR","IPO","BNB","ODL","KMT"};
        public static string[] MarketIndexesURlFlags = { "KSE100Index", "AllSharesIndex", "KSE30Index", "KMI30Index"};
